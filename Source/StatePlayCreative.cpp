...
void StatePlayCreative::LoadTextures()
{
	...
	menuSprite = new Sprite(TextureHelper::Instance()->GetTexture(TextureHelper::menu));//200
...
void StatePlayCreative::InitCreativeInventory()
{
	...
	inventoryItems.push_back(StoneBlock::getID());
	...
	inventoryItems.push_back(bedrock::getID());
	...
	inventoryItems.push_back(GravitySandBlock::getID());
	...
	inventoryItems.push_back(WaterBusket::getID());
	inventoryItems.push_back(LavaBusket::getID());
	...
	inventoryItems.push_back(YellowGlassBlock::getID());
	inventoryItems.push_back(GreenGlassBlock::getID());
	inventoryItems.push_back(PinkGlassBlock::getID());
	inventoryItems.push_back(PurpleGlassBlock::getID());
	inventoryItems.push_back(RedGlassBlock::getID());
	inventoryItems.push_back(BlackGlassBlock::getID());
	inventoryItems.push_back(BlueGlassBlock::getID());
	inventoryItems.push_back(GlassPanelItem::getID());
	inventoryItems.push_back(YellowGlassBlockPannelItem::getID());
	inventoryItems.push_back(GreenGlassBlockPannelItem::getID());
	inventoryItems.push_back(PinkGlassBlockPannelItem::getID());
	inventoryItems.push_back(PurpleGlassBlockPannelItem::getID());
	inventoryItems.push_back(RedGlassBlockPannelItem::getID());
	inventoryItems.push_back(BlackGlassBlockPannelItem::getID());
	inventoryItems.push_back(BlueGlassBlockPannelItem::getID());
	...
	inventoryItems.push_back(Redstone::getID());
	inventoryItems.push_back(GlowstoneBlock::getID());
	inventoryItems.push_back(Soulsand::getID());
	inventoryItems.push_back(Netherrack::getID());
	inventoryItems.push_back(MagmaBlock::getID());
	...
	inventoryItems.push_back(white_concrete_powder::getID());
	inventoryItems.push_back(yellow_concrete_powder::getID());
	inventoryItems.push_back(pink_concrete_powder::getID());
	inventoryItems.push_back(gray_concrete_powder::getID());
	inventoryItems.push_back(purple_concrete_powder::getID());
	inventoryItems.push_back(blue_concrete_powder::getID());
	inventoryItems.push_back(green_concrete_powder::getID());
	inventoryItems.push_back(red_concrete_powder::getID());
	inventoryItems.push_back(black_concrete_powder::getID());
	...
	inventoryItems.push_back(Saddle::getID());
	inventoryItems.push_back(Sign::getID());
	inventoryItems.push_back(FlowerPotItem::getID());
	inventoryItems.push_back(PaintningItem::getID());
	...
	creativePage = 0;
	creativePageMax = inventoryItems.size() / 25;
}
	...
	if (menuState == 0)//game state
	{
		if (invEn == false && craft3xEn == false && chestEn == false && furnaceEn == false)
		{
			...
			if (canCrouch == false)
			{
				// Fly Mode
				tickFlymode += dt;
				if (mSystemMgr->KeyPressed(PSP_CTRL_SELECT) && !keyHold(InputHelper::Instance()->getButtonToAction(13)) && !keyHold(InputHelper::Instance()->getButtonToAction(4)) && !keyHold(InputHelper::Instance()->getButtonToAction(5)) && !keyHold(InputHelper::Instance()->getButtonToAction(6)) && !keyHold(InputHelper::Instance()->getButtonToAction(7)))
				{
					if (tickFlymode > 1.3f)
					{
						tickFlymode = 0.0f;
				...
				if (keyHold(InputHelper::Instance()->getButtonToAction(13)))
				{
					if (sleepTime == 0.0f)
					{
						if (keyPressed(InputHelper::Instance()->getButtonToAction(14))) //open inventory
						{
							...
							upEn = tempUpInv;
							selectInvSprite->SetPosition(136 + (invXPosition * 22.0f), 102.5f + (invYPosition * 19.8f));
				...
				for (float i = 0; i < 5.25f; i += 0.15f)
				{
					...
					if (mWorld->invId[27 + barPosition] == WaterBusket::getID())
					{
						if (selectedBlock == Lava::getID())
						{
							...
							if (!blockBox.intersect(playerBox))
							{
								...
								mWorld->invId[27 + barPosition] = WaterBusket::getID();
					...
					if (mWorld->invId[27 + barPosition] == LavaBusket::getID())
					{
						if (selectedBlock == WaterBlock::getID())
						{
							...
							if (!blockBox.intersect(playerBox))
							{
								...
								mWorld->invId[27 + barPosition] = LavaBusket::getID();
					...
					if (mWorld->invId[27 + barPosition] == 290) //busket
					{
						...
						if (selectedBlock == 112) //if it is lava
						{
							...
							mWorld->invId[27 + barPosition] = 112;
					...
					if (mWorld->BlockEditable(testPos.x, testPos.y, testPos.z) && testBox.contains(testPos))
					{
						...
						if (selectedBlock == CraftingTable::getID()) // open crafting table menu
						{
							...
							upEn == true ? selectInvSprite->SetPosition(204 + (invXPosition * 17.5f), 26 + (invYPosition * 17.5f)) : selectInvSprite->SetPosition(96 + (invXPosition * 17.5f), 138 + (invYPosition * 17.5f));
						...
						if (selectedBlock == FurnaceOff::getID() || selectedBlock == FurnaceOn::getID())
						{
							...
							if (furnaceId != -1)
							{
								...
								upEn == true ? selectInvSprite->SetPosition(204, 28 + (invYPosition * 72)) : selectInvSprite->SetPosition(96 + (invXPosition * 17.5f), 138 + (invYPosition * 17.5f));
									...
									mWorld->invId[27 + barPosition] == Potato::getID())
								{
									...
									if (mWorld->CanPutBlockHere(testPos2.x, testPos2.y, testPos2.z, mWorld->invId[27 + barPosition]))
									{
										...
										if (mWorld->invId[27 + barPosition] < 250) // if block in our hands
										{
											...
											if (mWorld->invId[27 + barPosition] != -1) //multi-texturing blocks
											{
												...
												if (placed)
												{
													...
													{
														mWorld->invAm[27 + barPosition] -= 0;
														mWorld->invId[27 + barPosition] -= 0;
														mWorld->invSt[27 + barPosition] -= 0;
													}
													else
													{
										...
										else //if item in our hand
										{
											...
											/*if(mWorld->invId[27+barPosition] == DPurpleGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = GlassPanel::getID();//DPurpleGlassBlockPannel::getID();
											...
											if(mWorld->invId[27+barPosition] == BlueGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = BlueGlassBlockPannel::getID();//BlueGlassBlockPannel::getID();
											...
											/*if(mWorld->invId[27+barPosition] == LBlueGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = GlassPanel::getID();//BlueGlassBlockPannel::getID();
											...
											/*if(mWorld->invId[27+barPosition] == DBlueGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = GlassPanel::getID();//DBlueGlassBlockPannel::getID();
											...
											if(mWorld->invId[27+barPosition] == BrownGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = BrownGlassBlockPannel::getID();//BrownGlassBlockPannel::getID();
											...
											if(mWorld->invId[27+barPosition] == WhiteGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = WhiteGlassBlockPannel::getID();//WhiteGlassBlockPannel::getID();
											...
											if(mWorld->invId[27+barPosition] == GrayGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = GrayGlassBlockPannel::getID();//GrayGlassBlockPannel::getID();
											...
											if(mWorld->invId[27+barPosition] == LGrayGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = GlassPanel::getID();//LGrayGlassBlockPannel::getID();
											...
											if (mWorld->invId[27 + barPosition] == BlackGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = BlackGlassBlockPannel::getID();//BlackGlassBlockPannel::getID();
											...
											/*if(mWorld->invId[27+barPosition] == DGreenGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = GlassPanel::getID();
											...
											if (mWorld->invId[27 + barPosition] == RedGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = RedGlassBlockPannel::getID();
											...
											/*if(mWorld->invId[27+barPosition] == OrangeGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x,testPos2.y,testPos2.z) = OrangeGlassBlockPannel::getID();
											...
											if (mWorld->invId[27 + barPosition] == PurpleGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = PurpleGlassBlockPannel::getID();//PurpleGlassBlockPannel::getID();
											...
											if (mWorld->invId[27 + barPosition] == PinkGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = PinkGlassBlockPannel::getID();//PinkGlassBlockPannel::getID();
											...
											if (mWorld->invId[27 + barPosition] == GreenGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = GreenGlassBlockPannel::getID();//GreenGlassBlockPannel::getID();
											...
											if (mWorld->invId[27 + barPosition] == YellowGlassBlockPannelItem::getID()) // if it is glass panel
											{
												mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = YellowGlassBlockPannel::getID();//YellowGlassBlockPannel::getID();
											...
											if (mWorld->invId[27 + barPosition] == Redstone::getID()) // if it is Redstone item
											{
												bool placed = false;
												if (mWorld->GetBlock(testPos2.x + 1, testPos2.y, testPos2.z) == 0)
												{
													mWorld->GetBlock(testPos2.x, testPos2.y, testPos2.z) = Redstoneoff::getID();//Redstone off
													placed = true;
												}
											}
			...
			if (keyPressed(InputHelper::Instance()->getButtonToAction(14))) //remove cube
			{
				if (keyHold(InputHelper::Instance()->getButtonToAction(14)))
				{
					...
					for (float i = 0; i < 5.25f; i += 0.15f)
					{
						...
						if (mWorld->BlockEditable(testPos2.x, testPos2.y, testPos2.z) && testBox.contains(testPos2))
						{
							...
							if (oldBlock == GlassBlock::getID() || oldBlock == IceBlock::getID() || oldBlock == GlowstoneBlock::getID() || oldBlock == GlassPanel::getID() || oldBlock == YellowGlassBlock::getID() || oldBlock == GreenGlassBlock::getID() || oldBlock == PinkGlassBlock::getID())
							{
							...
							if (oldBlock == BlueGlassBlockPannel::getID() || oldBlock == BlackGlassBlockPannel::getID() || oldBlock == RedGlassBlockPannel::getID() || oldBlock == PurpleGlassBlockPannel::getID() || oldBlock == PinkGlassBlockPannel::getID() || oldBlock == GreenGlassBlockPannel::getID() || oldBlock == YellowGlassBlockPannel::getID())
							{
								mSoundMgr->PlayGlassSound();
							}
							else
							...
							if (oldBlock == PurpleGlassBlock::getID() /*|| oldBlock == OrangeGlassBlock::getID()*/ || oldBlock == RedGlassBlock::getID() /*|| oldBlock == DGreenGlassBlock::getID() */ || oldBlock == BlackGlassBlock::getID() /*|| oldBlock == LGrayGlassBlock::getID()*/)
							{
								mSoundMgr->PlayGlassSound();
							}
							else
							...
							if (/*oldBlock == WhiteGlassBlock::getID() || oldBlock == BrownGlassBlock::getID() /*|| oldBlock == DBlueGlassBlock::getID() || oldBlock == LBlueGlassBlock::getID() ||*/ oldBlock == BlueGlassBlock::getID() /*|| oldBlock == DPurpleGlassBlock::getID()*/)
							{
								mSoundMgr->PlayGlassSound();
							}
							else
		...
		{
			if (invEn == true || craft3xEn == false || chestEn == false || furnaceEn == false)
			{
				if (mSystemMgr->KeyPressed(PSP_CTRL_CROSS) || mSystemMgr->KeyPressed(PSP_CTRL_SQUARE))
				{
			...
			if (keyPressed(InputHelper::Instance()->getButtonToAction(14))) // If you hold the Right Trigger.
			{
				if (furnaceEn == true)
				{
			...
			if (invXPosition == 9 && invYPosition == 5) // Destroy Slot / Delete Block
			{
				if (invEn == true)
				{
					onDestroySlot = true;
			...
			if (keyPressed(InputHelper::Instance()->getButtonToAction(9)))
			{
				if (upEn == 0) // if your mouse in neither of craft menus
				{
					if (invEn == false)
					{
						...
						selectInvSprite->SetPosition(178 + (invXPosition * 17.5f), 155 + (invYPosition * 17.5f));
					}
					else
					{
						invXPosition != 9 ? invXPosition++ : invXPosition = 9;
						if (invYPosition < 5)
						{
							selectInvSprite->SetPosition(136 + (invXPosition * 22.0f), 102.5f + (invYPosition * 19.8f));
						}
						if (invYPosition == 5)
						{
							selectInvSprite->SetPosition(136 + (invXPosition * 22.0f), 209);
						}
					}
				}
				else
				{
					if (craft3xEn == 1)
					{
						...
						selectInvSprite->SetPosition(204 + (invXPosition * 17.5f), 26 + (invYPosition * 17.5f));
					}
					if (chestEn == 1) // if it is in chest
					{
						invXPosition != 8 ? invXPosition++ : invXPosition = 8;
						selectInvSprite->SetPosition(96 + (invXPosition * 17.5f), 26 + (invYPosition * 17.5f));
					}
				}
			}
			...
			if (keyPressed(InputHelper::Instance()->getButtonToAction(8)))
			{
				if (upEn == 0) // not only craft but chest too
				{
					...
					else
					{
						if (invYPosition < 5)
						{
							selectInvSprite->SetPosition(136 + (invXPosition * 22.0f), 102.5f + (invYPosition * 20.0f));
						}
						if (invYPosition == 5)
						{
							selectInvSprite->SetPosition(136 + (invXPosition * 22.0f), 209);
			...
			if (keyPressed(InputHelper::Instance()->getButtonToAction(11)))
			{
				...
				if (upEn == 0)
				{
					if (invEn == false)
					{
						...
						selectInvSprite->SetPosition(178 + (invXPosition * 17.5f), 138 + (invYPosition * 17.5f));
					}
					else
					{
						invYPosition != 5 ? invYPosition++ : invYPosition = 5;
				...
				else
				{
					if (craft3xEn == 1)
					{
						if (invYPosition == 2)
						{
							...
							selectInvSprite->SetPosition(96 + (invXPosition * 17.5f), 138 + (invYPosition * 17.5f));
							return;
						}
				...
				if (upEn == 0)
				{
					...
					else
					{
						...
						else
						{
							if (mWorld->mId == -1)
							{
								if (creativePage * 25 + invYPosition * 4 + invXPosition < inventoryItems.size())
								{
									mWorld->mId = inventoryItems[creativePage * 25 + invYPosition * 4 + invXPosition];

									if (inventoryItems[creativePage * 25 + invYPosition * 4 + invXPosition] >= 250)
									{		
										if (mWorld->StackableItem(inventoryItems[creativePage * 25 + invYPosition * 4 + invXPosition]))
										{
											mWorld->mAm = 1;
											mWorld->mSt = false;
										}
...
void StatePlayCreative::Update(StateManager* sManager)
{
	if (menuState == 0)//game state
	{
		...
		if (dt < 0.1f)
		{
			...
			if (sleepTime <= 0.0f)
			{
				...
				if (mWorld->SolidAtPointForPlayerHead(futureHeadPosition))
				{
					...
					playerPosition.y = (float)(blockIn - 0.2f);
					playerVelocity.y = 0.0f;
				}
			}
			...
			if (sleepTime <= 0.0f)
			{
				if (invEn == false && craft3xEn == false && chestEn == false && furnaceEn == false)
				{
					...
					{
						if (mSystemMgr->KeyHold(PSP_CTRL_SELECT))
						{
							playerPosition.y += 6.0f * dt;
						}
						if (mSystemMgr->KeyHold(PSP_CTRL_DOWN))
						{
							playerPosition.y -= 8.0f * dt;
						}
						playerVelocity.y = 0.0f;
					}
				}
		...
		{
			if (mWorld->haveCompass) // only if you have compass in bar slots, compass texture should update
			{
				mWorld->UpdateCompassTexture((fppCam->horAngle / 180.0f) * PI);
			}
		}
...
void StatePlayCreative::Draw(StateManager* sManager)
{
	...
	// draw dark mask
	if ((menuState != 0) && makeScreen == false)
	{
		DrawSetDepthTest(false);
		DrawSetDepthMask(true);
		DrawSetBlend(true);
	...
	if ((invEn == false && craft3xEn == false && chestEn == false && menuState == 0 && mWorld->mainOptions.guiDrawing == 1 && furnaceEn == false) || makeScreen == true)
	{
		for (int k = 0; k <= 8; k++)
		{
			if (mWorld->invId[27 + k] != -1)
			{
				...
				MatrixScale(Vector3(0.8f, 0.8f, 0.8f));
	...
	if (invEn == true)
	{
		for (int i = 0; i <= 4; i++)
		{
			for (int j = 0; j <= 9; j++)
			{
				if (creativePage * 25 + i * 4 + j < inventoryItems.size())
				{
					if (inventoryItems[creativePage * 25 + i * 4 + j] != -1)
					{
						sceGumPushMatrix();
						ScePspFVector3 loc = { 136 + j * 22.0f, 102.5f + i * 20.0f, 0.0f };
						sceGumTranslate(&loc);

						if (inventoryItems[creativePage * 25 + i * 4 + j] < 250)
						{
							MatrixScale(Vector3(0.65f, 0.65f, 0.65f));
							TextureManager::Instance()->SetTextureModeulate(texture_mips2);

							mWorld->drawHudCubes(inventoryItems[creativePage * 25 + i * 4 + j]);
						}

						if (inventoryItems[creativePage * 25 + i * 4 + j] >= 250)
						{
							MatrixScale(Vector3(0.65f, 0.65f, 0.65f));
							mWorld->ItemHaveTerrainTexture(inventoryItems[creativePage * 25 + i * 4 + j]) ? TextureManager::Instance()->SetTextureModeulate(texture) : TextureManager::Instance()->SetTextureModeulate(barItems);

							mWorld->drawHudItems(inventoryItems[creativePage * 25 + i * 4 + j]);
						}
						sceGumPopMatrix();
					}
				}
	...
	if (invEn == true || craft3xEn == true || chestEn == true || furnaceEn == true) // Bottom row
	{
		for (int k = 0; k <= 9; k++)
		{
			if (mWorld->invId[27 + k] != -1)
			{
				...
				{
					MatrixScale(Vector3(0.65f, 0.65f, 0.65f));
					ScePspFVector3 loc = { 209.5f + k * 33.8f, 322.0f, 0.0f };
					sceGumTranslate(&loc);
				}
				else
				{
					MatrixScale(Vector3(0.55f, 0.55f, 0.55f));
					ScePspFVector3 loc = { 480 + k * 17.5,405,0.0f };
					sceGumTranslate(&loc);
				}
		...
		if (mWorld->mId != -1) //MOUSE ITEM
		{
			...
			{
				if (invEn == false) // Grabbed Item
				{
					MatrixScale(Vector3(0.7f, 0.7f, 0.7f));
					ScePspFVector3 loc = { 96 + (invXPosition * 36),130 + (invYPosition * 36),0.0f };
					sceGumTranslate(&loc);
				}
				else
				{
					MatrixScale(Vector3(0.75f, 0.75f, 0.75f));
					ScePspFVector3 loc = { 179 + (invXPosition * 29.5f), 135 + (invYPosition * 28.5f), 0.0f }; 
					sceGumTranslate(&loc);
				}
			}
	...
	if (invEn == true || craft3xEn == true || chestEn == true || furnaceEn == true)
	{
		...
		int slide_y = 101 + ((float)creativePage / (float)creativePageMax) * 86;
		sliderSprite->SetPosition(359.5f, slide_y);
		sliderLightedSprite->SetPosition(359.5f, slide_y);
	...
	mRender->SetFontStyle(normal_size, GU_COLOR(1, 1, 1, 1), GU_COLOR(0.0f, 0.0f, 0.0f, 1), 0x00000200);
	...
	if (invEn == false && craft3xEn == false && chestEn == false && furnaceEn == false && menuState == 0)
	{
		if (tickShowSlotName > 0.0f)
		{
			...
			if (mWorld->invId[27 + barPosition] != -1)
			{
				...
				mRender->DebugPrint(240, 191, "%s", slotName.c_str());
			}
		}
		...
		if (inputDiskNameTimer > 0.0f)
		{
			...
			mRender->DebugPrint(240, 56, "%s", inputDiskName.c_str());
	...
	if (menuState == 1)
	{
		if (menuOptions)
		{
			...
			{
			case 0:
				DrawText(371, 86, GU_COLOR(0.28f, 0.28f, 0.28f, 1), normal_size, "Difficulty: Peaceful");
				...
				break;
			case 1:
				DrawText(371, 86, GU_COLOR(0.28f, 0.28f, 0.28f, 1), normal_size, "Difficulty: Easy");
				optionsMenuPos == 9 ? RenderManager::InstancePtr()->SetFontStyle(normal_size, GU_COLOR(1, 1, 0, 1), 0, 0x00004000 | 0x00000200) : RenderManager::InstancePtr()->SetFontStyle(normal_size, GU_COLOR(1, 1, 1, 1), 0, 0x00004000 | 0x00000200);
				mRender->DebugPrint(370, 85, "Difficulty: Easy");
				break;
			case 2:
				DrawText(371, 86, GU_COLOR(0.28f, 0.28f, 0.28f, 1), normal_size, "Difficulty: Normal");
				optionsMenuPos == 9 ? RenderManager::InstancePtr()->SetFontStyle(normal_size, GU_COLOR(1, 1, 0, 1), 0, 0x00004000 | 0x00000200) : RenderManager::InstancePtr()->SetFontStyle(normal_size, GU_COLOR(1, 1, 1, 1), 0, 0x00004000 | 0x00000200);
				mRender->DebugPrint(370, 85, "Difficulty: Normal");
				break;
			case 3:
				DrawText(371, 86, GU_COLOR(0.28f, 0.28f, 0.28f, 1), normal_size, "Difficulty: Hard");
				optionsMenuPos == 9 ? RenderManager::InstancePtr()->SetFontStyle(normal_size, GU_COLOR(1, 1, 0, 1), 0, 0x00004000 | 0x00000200) : RenderManager::InstancePtr()->SetFontStyle(normal_size, GU_COLOR(1, 1, 1, 1), 0, 0x00004000 | 0x00000200);
