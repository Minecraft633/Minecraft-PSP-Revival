...
void InputHelper::Init()
{
	...
	//switch block
	actionNames[8] = std::string("Cycle Item Left");
	actionNames[9] = std::string("Cycle Item Right");
	actionNames[10] = std::string("Cycle Item Up");
	actionNames[11] = std::string("Cycle Item Down");

	actionNames[12] = std::string("Jump");
	actionNames[13] = std::string("Use");
	actionNames[14] = std::string("Action");
	...
	buttonNames[8] = std::string("Left Trigger");
	buttonNames[9] = std::string("Right Trigger");
...
{
	FILE* pFile;
	pFile = fopen("Save/options.cf", "wb");
	...
	fwrite(&Limit_RAM, sizeof(bool), 1, pFile);
...
{
	FILE* pFile;
	pFile = fopen("Save/options.cf", "rb");
	...
	fread(&Limit_RAM, sizeof(bool), 1, pFile);
